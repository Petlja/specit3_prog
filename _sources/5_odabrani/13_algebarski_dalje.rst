...
`Велики прости бројеви <https://petlja.org/biblioteka/r/Zbirka3/veliki_prosti_brojevi>`_ у Петљиној 
...
пар страница даље, али цело поглавље може да буде занимљиво. На пример, на страници `Криптографија 
