...
::
   ...
   **Језици за обележавање** омогућавају креирање форматираних
   ...
   додатно обележава специјалним ознакама.
...
специјализованим програмским језицима (нпр. AWK, Perl), а данас се
...
текстуалног садржаја записаног у неком од језика за обележавање (ми
...
да представља релативну путању од тренутне до циљне датотеке. Пожељно
